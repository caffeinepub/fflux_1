...
import type { BuildEntry as _BuildEntry, ExternalBlob as _ExternalBlob, UploadBuildInput as _UploadBuildInput, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getBestBuildForDevice(): Promise<BuildEntry> {
        if (this.processError) {
            try {
                const result = await this.actor.getBestBuildForDevice();
                return from_candid_BuildEntry_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getBuild(arg0: string): Promise<BuildEntry> {
        if (this.processError) {
            try {
    ...
    async getDeviceProfile(arg0: Principal): Promise<DeviceProfile> {
        if (this.processError) {
            try {
                const result = await this.actor.getDeviceProfile(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listBuilds(arg0: string | null): Promise<Array<BuildEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.listBuilds(to_candid_opt_n16(this._uploadFile, this._downloadFile, arg0));
    ...
    async registerDeviceProfile(arg0: DeviceProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.registerDeviceProfile(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadBuild(arg0: UploadBuildInput): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadBuild(await to_candid_UploadBuildInput_n18(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_BuildEntry_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _BuildEntry): Promise<BuildEntry> {
...
async function from_candid_vec_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_BuildEntry>): Promise<Array<BuildEntry>> {
    return await Promise.all(value.map(async (x)=>await from_candid_BuildEntry_n10(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_UploadBuildInput_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: UploadBuildInput): Promise<_UploadBuildInput> {
